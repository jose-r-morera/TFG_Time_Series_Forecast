...
####################################################
# Past data: Conv1D + MaxPooling + Flatten
past_data_layer = tf.keras.layers.Input(shape=past_data_shape, name="past_data")
x1 = tf.keras.layers.Conv1D(32, 3, activation='relu', padding='causal')(past_data_layer)
...
outputs = tf.keras.layers.Dense(target_shape, name='outputs')(y)
