...
encoder_lstm = tf.keras.layers.Bidirectional(tf.keras.layers.LSTM(350, return_sequences=False))(past_data_layer)
#encoder_lstm = tf.keras.layers.Bidirectional(tf.keras.layers.LSTM(190))(encoder_lstm)
...
decoder_lstm = tf.keras.layers.LSTM(300)(future_data_layer)
...
merged = Attention(400)(merged_lstm)
...
es_callback = tf.keras.callbacks.EarlyStopping(monitor="val_loss", min_delta=0, patience=4)
