...
Para determinar todas estas variables, se hace uso de una herramienta de ajuste fino (fine-tuning) de los hiperparámetros. En particular, se emplea Keras Tuner, y el método de búsqueda
