...
Se agrgan los datos con frecuencia horaria mediante la media.
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{images/visualizacion_1.png}
    \caption{Visualización de la temperatura del aire en San Cristóbal de La Laguna.}
    \label{visualizacion_1}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{images/visualizacion_2.png}
    \caption{Visualización de la temperatura del aire en San Cristóbal de La Laguna.}
    \label{visualizacion_2}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{images/visualizacion_3.png}
    \caption{Visualización de la temperatura del aire en San Cristóbal de La Laguna.}
...
\begin{table}[htb]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        \hline
        La Cuesta & 0.2\% & 0.1\% & 0.1\% \\
        La Punta del Hidalgo & 0.3\% & 0.2\% & 0.2\% \\
        Camino de Chasna & 0.4\% & 0.3\% & 0.3\% \\
        Punta de Rasca & 0.5\% & 0.4\% & 0.4\% \\
        \hline
    \end{tabular}
