...
\begin{itemize}
    ...
    Se emplea la API de predicciones pasadas\cite{open_meteo_api}. Se seleccionan los modelos ICON Global del servicio meteorológico alemán (DWD) y el modelo ARPEGE Europe de Météo-France, al ser los de mayor resolución.
    Ambos modelos generan predicciones horarias, actualizadas cada 3 horas. Se explora la posibilidad de emplear las predicciones del modelo HAROME de la AEMET, pero no están disponibles de forma pública
\end{itemize}
...
Se observa que en la presión atmosférica las mediciones de todas las fuentes son muy similares. Sin embargo, 
...
este valor, así como otros cercanos, observando en los histogramas los datos detectados como anómalos.
...
Como datos pasados empleamos la variable meteorológica estudiada, así como las restantes como covariables. Se comprueba empíricamente que 
