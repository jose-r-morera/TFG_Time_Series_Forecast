...
TF model that combines CNN layers with LSTM. Many combinations were tried
and this was the best found. 

Trains and evaluates the model for the specified configuration.
