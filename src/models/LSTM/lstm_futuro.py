...
"""
LSTM model with exogenous future covariates
===========

Model, train and validate a simple LSTM model for time series forecasting.
...
DATA_PATH = "../3_data_windows/f3_estaciones/paquetes_s6_cov_punta_hidalgo_p24.pkl"
