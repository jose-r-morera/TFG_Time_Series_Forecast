...
"""
Parameter Grid Search for past window size in CNN
===========

Automatizes model creation and evaluation for different past window sizes, 
selecting the best based on validation loss.
