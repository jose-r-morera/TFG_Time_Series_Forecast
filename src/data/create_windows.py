...
"""
Data Windows Creation
===========
This script creates data windows from preprocessed time series data for different locations and targets.

"Windows" = packages of past time grouped using a sliding window approach.
