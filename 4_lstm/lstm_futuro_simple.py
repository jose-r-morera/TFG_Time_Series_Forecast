...
encoder_lstm = tf.keras.layers.LSTM(160, return_sequences=False)(encoder_lstm)
# dropout
...
decoder_lstm = tf.keras.layers.Bidirectional(tf.keras.layers.LSTM(80, return_sequences=False))(future_data_layer)
